...
function procesarlogin(){
	...
	//seleccion simple
	if(formu.children[31].value=="varias veces"){
		puntos=puntos+3;
	}
	if(formu.children[35].value=="condiciones"){
		puntos=puntos+3;
	}
	//seleccion multiple
	if(formu.children[42].checked && formu.children[46].checked &&
	!formu.children[44].checked && !formu.children[48].checked){
		puntos=puntos+4;
	}	
	if(formu.children[53].checked && formu.children[59].checked &&
	!formu.children[57].checked && !formu.children[55].checked){
		puntos=puntos+4;
	}
...
function procesarnota(){
	...
	notanumero.textContent="puntos:"+puntos+"/20";}else{location.href="nocalifico.html";}
...
function procesacerti(){
	location.href="certificadopython.html";
